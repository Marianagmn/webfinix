...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'business-finance', canActivate: [businessGuard], loadChildren: () => import('./features/business-finance/business-finance.routes').then(m => m.BUSINESS_FINANCE_ROUTES) },
